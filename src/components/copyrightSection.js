...
return (
  <Box height={["190vh", "auto"]} key={section.sectionType} backgroundColor={section.backgroundColor.hex} color={section.textColor.hex} id={section.sectionType}>
    ...
    <Box textAlign="justify" margin="auto" w={["90%","50%"]} mb={5} flexWrap="wrap" fontSize={["14px", "12px"]}>
